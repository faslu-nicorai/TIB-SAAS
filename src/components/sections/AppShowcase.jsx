...
const AppShowcase = () => {
    ...
    return (
        <div ref={trackRef} className={`relative ${isMobile ? "h-auto" : "h-[400vh]"}`}>
            <section id="app-showcase" className={`${isMobile ? "relative" : "sticky top-0"
                } h-screen py-20 px-25 bg-white overflow-hidden relative z-10`}>
                    ...
                    <div className="relative w-full h-full">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-center w-full">
                            ...
                            <div>
                                {isMobile ? (
                                    <>
                                        <h2 className="text-4xl md:text-6xl font-extrabold text-[#141414] mb-2">
                                            1,150+ Companies
                                        </h2>
                                        <h3 className="text-4xl md:text-6xl font-extrabold text-[#141414] mb-2">
                                            550,400+ Orders
                                        </h3>
                                        <p className="text-4xl md:text-6xl font-extrabold text-[#141414]">
                                            290,500+ Invoices
                                        </p>
                                    </>
                                ) : (
